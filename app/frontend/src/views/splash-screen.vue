<template>
  <div class="wrapper-dark">
    <div class="center">
      ...
      <span class="loading loading-lg loadingsplash"></span
      ><span class="message_splash">{{ message }}</span>
    </div>
  </div>
</template>
    ...
    setInterval(
      function () {
        ...
        this.letters.forEach((l) => {
          res += l.charAt(this.generate_random(0, 9));
        });
        this.title = res;
        setTimeout(
          function () {
          ...
          this.generate_random(30, 100)
        );
      }.bind(this),
      this.generate_random(500, 4000)
    );
